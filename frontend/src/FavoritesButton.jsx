...
// }
    ...
    return isSuccessful ? <Button className="favBtn-clicked"><i className="bi bi-suit-heart-fill"></i> Added!</Button> :
    <Button onClick={handleOnClick} className="fav-btn" type="submit"><i className="bi bi-suit-heart"></i> Add to Favorites</Button>;
}
